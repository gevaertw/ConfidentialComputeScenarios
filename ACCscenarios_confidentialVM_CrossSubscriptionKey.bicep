...
resource diskEncryptionSet 'Microsoft.Compute/diskEncryptionSets@2022-07-02' = {
  ...
  identity: {
    ...
    userAssignedIdentities: {
      '${diskEncryptionKeyvaultManagedIdentityID}': {}
    }
  }
  properties: {
    activeKey: {
...
resource vm 'Microsoft.Compute/virtualMachines@2023-03-01' = {
  ...
  tags: tagList
  dependsOn: [
    diskEncryptionSet, vmNIC, VMsubnet
  ]
  properties: {
    hardwareProfile: {
      vmSize: vmSize //README point 5
    }
    osProfile: {
      computerName: vmName
    ...
    storageProfile: {
      ...
      osDisk: {
        ...
        managedDisk: {
          ...
          diskEncryptionSet: {
            id: diskEncryptionSet.id // README point 2
          }
          securityProfile: {
      ...
      dataDisks: [
        {
          ...
          managedDisk: {
            storageAccountType: dataDisk01Type
            diskEncryptionSet: {
              id: diskEncryptionSet.id // README point 3
            }
          }
          deleteOption: 'Delete'
          diskSizeGB: 1024
    ...
    securityProfile: {
      encryptionAtHost: true  // README point 1
      securityType: 'ConfidentialVM'  //README point 4
        uefiSettings: {
